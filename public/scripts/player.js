...
//   constructor() {
//     this.sampleBPM = 182
//     this.sampleLengthInBeats = 8;
//     this.sampleFolderPath = "../assets/drum-samples/";
//     this.sampleURLs = { ["swing_loop_182bpm"]: "swing_loop_182bpm.wav" };
//   }
//
//   get nextSample() {
//     return this.bassLine.pop();
//   }
// }
//
// player.Bass = class {
//   constructor() {
//     this.sampleBPM = 120;
//     this.sampleLengthInBeats = 1;
//     this.sampleFolderPath = "../assets/bass-samples/";
//     this.sampleURLs = { ["E1"]: "E1.mp3", ["F1"]: "F1.mp3", ["F#1"]: "Fs1.mp3", ["G1"]: "G1.mp3", ["G#1"]: "Gs1.mp3", ["A1"]: "A1.mp3", ["A#1"]: "As1.mp3", ["B1"]: "B1.mp3",
...
//   LT(chord) {
//     let leadingTones = [
//       chord.root.addInterval(theory.INTERVALS.m2),
//       chord.root.subtractInterval(theory.INTERVALS.m2),
//       chord.getNoteAtScaleDegree(2),
//       chord.getNoteAtScaleDegree(5),
//       chord.getNoteAtScaleDegree(7)
//     ];
...
//   NCT(chord, note) {
//     const chordTones = [
//       chord.getNoteAtScaleDegree(1),
//       chord.getNoteAtScaleDegree(3),
//       chord.getNoteAtScaleDegree(5),
//       chord.getNoteAtScaleDegree(6),
//       chord.getNoteAtScaleDegree(7)];
